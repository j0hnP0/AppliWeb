        ...
        <div class="wrapper">
            ...
            <table class="tbl-full">
                ...
                <?php
                    ...
                    //execute the query
                    $res = mysqli_query($conn, $sql);   //THIS LINE SHOWING ERROR
                    
                    //check whether the query is executed or not
                    if($res==TRUE)
                    {
                        // Count rows to check whether e have ta in database or not
                         ...
                         if($count>0) 
                        {
                            ...
                            {
                                //using while loop to get ll the data from database.
                ...
                <?php
                        ...
                        {
                            //we do not have data in the databse
                        }
                    }
                ?>
